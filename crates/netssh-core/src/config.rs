...
impl AdvancedDeviceConfig {
    ...
    pub fn from_shared_config(
        ...
        Self {
            ...
            password: None,
            secret: None,
            default_port: shared_config.network.default_ssh_port,
            connection_timeout: Duration::from_secs(shared_config.network.tcp_connect_timeout_secs),
            read_timeout: Duration::from_secs(shared_config.network.tcp_read_timeout_secs),
            write_timeout: Duration::from_secs(shared_config.network.tcp_write_timeout_secs),
            read_buffer_size: shared_config.buffer.read_buffer_size,
            pattern_timeout: Duration::from_secs(shared_config.network.pattern_match_timeout_secs),
            auto_clear_buffer: shared_config.buffer.auto_clear_buffer,
            retry_count: shared_config.network.max_retry_attempts,
            retry_delay: Duration::from_millis(shared_config.network.retry_delay_ms),
            enable_session_log: shared_config.logging.enable_session_log,
            session_log_path: shared_config.logging.session_log_path.clone(),
            blocking_timeout: get_ssh_timeout(SshTimeoutType::Blocking),
        }
    }
}
